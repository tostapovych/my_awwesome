...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "1-[WEB]", "2-[WORK]", "3-[TERM]", "4-[LOG]",
    "5-[SSH]", "6-[APP]", "7-[MISC]", "8-[FLOAT]", "9-[ROOT]" }, s, layouts[1])
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    -- Screenshot
    awful.key({ modkey, "Tab" }, "s", function () awful.util.spawn("deepin-screenshot") end),
...
os.execute("nitrogen --set-zoom-fill --save $HOME/Downloads/ninjas.png")
os.execute("xrandr --output VGA-0 --auto --output DVI-I-1 --auto --right-of VGA-0")
-- }}}
